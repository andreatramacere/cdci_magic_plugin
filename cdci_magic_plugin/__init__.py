...
def find_config():
    config_file_resolution_order=[
        os.environ.get('CDCI_MAGIC_PLUGIN_CONF_FILE','.magic_data_server_conf.yml'),
        os.path.join(conf_dir,'data_server_conf.yml'),
        "/dispatcher/conf/conf.d/magic_data_server_conf.yml",
    ]
    ...
    raise RuntimeError("no magic config found tried: "+", ".join(config_file_resolution_order))
